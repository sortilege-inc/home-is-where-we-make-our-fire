...
window.TorDice = (function () {
  ...
  const GLYPHS = {
    ...
    // Success die 6 — the Tengwar rune Harma (aha): a raised stem over a single
    // open bow. Tallies great successes.
    tengwar: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8C9 6 5 10 5.5 14.3 6 18.2 10.4 19.7 15 18"/><path d="M16 8V3.2"/></svg>'
  };
