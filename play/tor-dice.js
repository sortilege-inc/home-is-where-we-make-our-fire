...
window.TorDice = (function () {
  ...
  const GLYPHS = {
    ...
    // Success die 6 — the Tengwar rune (an open curl, "ᴄ"): a great-success tally.
    tengwar: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round"><path d="M17 6.5C9.5 4.5 5 8.5 5 13.5 5 18.5 9.5 22 17 20"/></svg>'
  };
